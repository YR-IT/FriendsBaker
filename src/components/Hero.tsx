        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center text-center lg:text-left justify-items-center lg:justify-items-start">
            ...
            >
              ...
              <div className="space-y-3 text-center lg:text-left">
                <h1 className="text-2xl sm:text-3xl lg:text-6xl font-extrabold leading-snug">
                ...
                <p className="text-sm sm:text-base text-blue-900/80 max-w-sm sm:max-w-lg mx-auto lg:mx-0 leading-relaxed bg-white/60 backdrop-blur-sm px-3 py-2 rounded-lg lg:bg-transparent lg:p-0">
                ...
                <div className="relative bg-white/70 backdrop-blur-md border border-blue-200 rounded-3xl p-6 shadow-2xl hover:shadow-blue-200/60 transition-shadow duration-500">
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      <div
                        key={i}
                        className="flex items-center gap-4 p-3 bg-white/80 rounded-xl border border-blue-200 hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
                      >
