      ...
      <div className="relative z-10">
        ...
        >
          <h1 className="text-5xl font-bold text-blue-900 mb-4 drop-shadow-lg">
            Get in Touch with{" "}
            <span className="text-blue-600">Friends Baker</span>
          </h1>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            <div className="bg-white/80 backdrop-blur-xl shadow-2xl rounded-3xl p-8 space-y-6 border border-blue-100 transition hover:shadow-blue-200/60">
              <motion.input
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-xl py-3 text-lg font-semibold shadow-lg transition"
              >
          ...
          >
            ...
            >
              ...
              <a
                ...
                className="text-gray-800 text-lg font-medium hover:text-blue-800 transition"
              >
        ...
        <motion.div
          ...
          className="mt-20 w-full h-96 md:h-[500px] rounded-2xl overflow-hidden shadow-2xl border border-blue-200"
        >
          <iframe
